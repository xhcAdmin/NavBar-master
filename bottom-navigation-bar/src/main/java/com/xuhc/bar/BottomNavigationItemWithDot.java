...
import com.xuhc.bar.dot.DismissListener;
...
//    }
    ...
    public void setOnDismissListener(final OnDismissListener barOnDismissListener) {
        if (barOnDismissListener != null)
            mDotView.setOnDismissListener(new DismissListener() {
                @Override
                public void dismiss(DotView view) {
                    barOnDismissListener.dismiss(view, mPosition);
                }
            });
    }
