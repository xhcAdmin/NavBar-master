 ...
 */
 ...
 class BottomNavigationBarContent extends LinearLayout {
    ...
    public void setBarOnDismissListener(OnDismissListener barOnDismissListener) {
       int size = getChildCount();
       for (int i=0;i<size;i++){
           Log.e("123456","barOnDismissListener ="+barOnDismissListener.toString());
           BottomNavigationItemWithDot item = (BottomNavigationItemWithDot)getChildAt(i);
           item.setOnDismissListener(barOnDismissListener);
       }
    }
